...
From the above scatter plot, we can see that there is a decreasing relationship between the number of views and the like rate, which means the more in views, the lower in like rate. However, there is no obvious relationship between the number of subscriptions and like rate.
