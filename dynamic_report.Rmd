...
# Which one gets higher views?
latest_data %>%
  ggplot() +
    geom_bar(aes(x = Views, fill = Type)) +
  labs(title = "Which one gets higher views?",
       subtitle = "Comparing numbers of views with two types of videos",
       caption = "Source: Youtube",
       x = "Number of views")  
...
However we can see there is a big difference between mean of likes and rest, therefore we can create another variable that define the likes rate of each video/short.
